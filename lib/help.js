...
exports.getText = function (options) {
  ...
  addLine('Usage:')
  addLine()
  addLine('  parallel [options] [command [arguments]] < list_of_arguments')
  addLine('  parallel [options] [command [arguments]] (::: arguments)...')
  addLine('  cat ... | parallel --pipe [options] [command [arguments]]')
  addLine()
  addLine('Options:')
